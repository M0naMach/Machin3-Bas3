      ...
      <div className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 border border-ivory-dark/30 shadow-sm">
              <h3 className="text-2xl font-semibold text-charcoal mb-4">Custom Bot Development</h3>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 border border-ivory-dark/30 shadow-sm">
              <h3 className="text-2xl font-semibold text-charcoal mb-4">Business Support Services</h3>
              <p className="text-charcoal/70 mb-4">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 border border-ivory-dark/30 shadow-sm">
              <h3 className="text-2xl font-semibold text-charcoal mb-4">Design & Branding</h3>
              <p className="text-charcoal/70 mb-4">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 border border-ivory-dark/30 shadow-sm">
              <h3 className="text-2xl font-semibold text-charcoal mb-4">Future Vision</h3>
              <p className="text-charcoal/70 mb-4">
